// bulldozer.js
async function bulldozernew(alya, target) {
    ...
    await alya.relayMessage("status@broadcast", OndetMsg1.message, {
    ...
    await alya.relayMessage("status@broadcast", OndetMsg2.message, {
